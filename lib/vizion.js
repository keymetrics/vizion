...
vizion.analyze = function(argv, cb) {
  ...
  identify(_folder, function(type, folder) {
    if (type === 'git')
    {  return git.parse(folder, cb);console.log(folder);} // temporary
    else if (type === 'hg')
...
//   if (!rev)
//     return cb({msg: 'Cannot revert to an invalid commit revision', folder: _folder});

//   identify(_folder, function(type, folder) {
//     if (type === 'git')
//       return git.revert(folder, cb);
//     else if (type === 'hg')
//       return hg.revert(folder, cb);
//     else if (type === 'svn')
//       return svn.revert(folder, cb);
//     else
//       return cb({
//         msg : type,
//         path : folder
